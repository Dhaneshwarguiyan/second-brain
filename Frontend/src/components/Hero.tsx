      ...
      <div className="h-[85vh] flex  justify-between sm:w-[80%] px-4 m-auto relative">
        <div className="h-full">
          <div className="h-full text-black-300 flex flex-col gap-2 sm:justify-center mt-32 sm:mt-0 items-center sm:items-start">
            ...
            <span className="sm:text-8xl text-7xl font-bold mb-5 brain text-pretty text-center sm:text-start">
              Second Brain!
            </span>
        ...
        <div className="sm:flex gap-4 justify-center items-center hidden">
          <img
            src={img1}
            alt=""
            className="w-[800px] object-contain rounded-lg z-10"
          />
          <span className="absolute translate-y-[-150px] translate-x-[-50px] rotate-[-45deg] hidden sm:block ">
            <img src={img2} alt="" className="w-[200px] rounded-3xl" />
          </span>
          <span className="absolute z-0 translate-x-[150px] translate-y-[-100px] rotate-45 hidden sm:block">
            <img src={img15} alt="" className="w-[300px] rounded-3xl" />
          </span>
        </div>
      </div>
    </div>
